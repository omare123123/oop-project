...
namespace Finaaal
{
    public partial class trex : Form
    {
        ...
        private void MainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            // jumping is not true
            if (rex.Top >= 380 && !jumping)
            {
                // then we do the following
                force = 12; // set the force to 8
                rex.Top = floor.Top - rex.Height; // also we place the player on top of the picture box
        ...
        public void resetGame()
        {
            ...
            rex.Image = Properties.Resources.running; // change the t rex image to running
